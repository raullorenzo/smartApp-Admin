...
module.exports = function (app) {
    ...
    AddTemp =  function(location, temperature){
        ...
        temp.save(function(err, temp){
            ...
            console.log('1------------------------');
            console.log('loc26:',loc26);
            console.log('loc27:',loc27);
            console.log('loc28:',loc28);
            console.log('loc29:',loc29);
            console.log('ok:',ok);
            console.log('1------------------------');
            if(temp.location == 'chariot.c3526'){loc26 = 1;}
            console.log('2------------------------');
            console.log('loc26:',loc26);
            console.log('loc27:',loc27);
            console.log('loc28:',loc28);
            ...
            console.log('ok:',ok);
            console.log('2------------------------');
            if(temp.location == 'chariot.c3527'){loc27 = 1;}
            console.log('3------------------------');
            console.log('loc26:',loc26);
            console.log('loc27:',loc27);
            console.log('loc28:',loc28);
            ...
            console.log('ok:',ok);
            console.log('3------------------------');
            if(temp.location == 'chariot.c3528'){loc28 = 1;}
            console.log('4------------------------');
            console.log('loc26:',loc26);
            console.log('loc27:',loc27);
            console.log('loc28:',loc28);
            ...
            console.log('ok:',ok);
            console.log('4------------------------');
            if(temp.location == 'chariot.c3529'){loc29 = 1;}
            console.log('5------------------------');
            console.log('loc26:',loc26);
            console.log('loc27:',loc27);
            console.log('loc28:',loc28);
